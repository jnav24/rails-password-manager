...
```sh
git clone https://github.com/nickjj/docker-rails-example rails_password_manager
cd rails_password_manager
...
The app is named `rails_password_manager` right now but chances are your app will be a different
name. Since the app is already created we'll need to do a find / replace on a
few variants of the string "rails_password_manager" and update a few Docker related resources.
